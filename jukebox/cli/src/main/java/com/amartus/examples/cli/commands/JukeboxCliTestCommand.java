 ...
 */
package com.amartus.examples.cli.commands;
...
public class JukeboxCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(JukeboxCliTestCommand.class);
    protected final JukeboxCliCommands service;

    public JukeboxCliTestCommand(final JukeboxCliCommands service) {
